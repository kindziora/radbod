    ...
    render(change) {
        ...
        if (this.template) {
            ...
            if (typeof ((_c = this.getListContainer()) === null || _c === void 0 ? void 0 : _c.template) === "function") {
                ...
                this.$el.innerHTML = (_e = para === null || para === void 0 ? void 0 : para.firstChild) === null || _e === void 0 ? void 0 : _e.innerHTML;
            }
            else {
                this.$el.innerHTML = this.template.call(this, Object.assign(Object.assign({ change }, stores), { _t: this.dom._t }));
            }
            (_g = (_f = this.dom.store) === null || _f === void 0 ? void 0 : _f.events) === null || _g === void 0 ? void 0 : _g.dispatchEvent(this.dom.name, this.dom.name, "post_render", { change: change, domScope: this.$el });
        }
        else {
